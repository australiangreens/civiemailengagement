...
/**
 * ContactEmailEngagement.Runqueue API specification (optional)
 ...
 */
function _civicrm_api3_contact_email_engagement_Runqueue_spec(&$spec) {
  $spec['max_runtime'] = [
...
/**
 * ContactEmailEngagement.Runqueue API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_contact_email_engagement_Runqueue($params) {
  $returnValues = [];
  // retrieve the queue
  ...
  return civicrm_api3_create_success($returnValues, $params, 'ContactEmailEngagement', 'Runqueue');
}
